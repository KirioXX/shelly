...
When your request is ambiguous, shelly can ask for clarification using a selectable list interface:
...
Skills are downloaded, extracted, and validated (requires `SKILL.md` file) to `~/.config/shelly/skills/`.
...
For the full skills system documentation, see [SKILLS.md](SKILLS.md).
